...
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "TicketingSystemClients";
...
builder.Services.AddValidatorsFromAssemblyContaining<TicketingSystem.Application.Validators.LoginRequestValidator>();
